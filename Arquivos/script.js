...
const SUFIXOS = {
    'DWG': ['TERREO', 'LAZER', 'COBERTURA', 'MEZANINO', 'CORTES', 'GERAL', 'TIPO', 'GARAGEM', 'FACHADA', 'DUPLEX', 'ROOFTOP', 'LOGO', 'ACABAMENTOS', 'ESQUADRIA', 'ARQUITETONICO', 'REFERENCIA', 'IMPLANTACAO', 'SUBSOLO', 'G1', 'G2', 'G3', 'G4', 'DUPLEX_SUPERIOR', 'DUPLEX_INFERIOR', 'TOON', 'DIFERENCIADO', 'CAIXA_AGUA', 'CASA_MAQUINA', 'PENTHOUSE'],
    'PDF': ['DOCUMENTACAO', 'RELATORIO', 'LOGO', 'ARQUITETONICO', 'REFERENCIA', 'ESQUADRIA', 'ACABAMENTOS', 'TIPOLOGIA', 'IMPLANTACAO', 'SUBSOLO', 'G1', 'G2', 'G3', 'G4', 'DUPLEX_SUPERIOR', 'DUPLEX_INFERIOR', 'TERREO', 'LAZER', 'COBERTURA', 'MEZANINO', 'CORTES', 'GERAL', 'TIPO', 'GARAGEM', 'FACHADA', 'TOON', 'DIFERENCIADO', 'PENTHOUSE'],
