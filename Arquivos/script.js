...
const SUFIXOS = {
    'DWG': ['TERREO', 'LAZER', 'COBERTURA', 'MEZANINO', 'CORTES', 'GERAL', 'TIPO', 'GARAGEM', 'FACHADA', 'DUPLEX', 'ROOFTOP', 'LOGO', 'ACABAMENTOS', 'ESQUADRIA', 'ARQUITETONICO', 'REFERENCIA', 'IMPLANTACAO', 'SUBSOLO', 'G1', 'G2', 'G3', 'DUPLEX_SUPERIOR', 'DUPLEX_INFERIOR', 'TOON'],
    'PDF': ['DOCUMENTACAO', 'RELATORIO', 'LOGO', 'ARQUITETONICO', 'REFERENCIA', 'ESQUADRIA', 'ACABAMENTOS', 'TIPOLOGIA', 'IMPLANTACAO', 'SUBSOLO', 'G1', 'G2', 'G3', 'DUPLEX_SUPERIOR', 'DUPLEX_INFERIOR', 'TERREO', 'LAZER', 'COBERTURA', 'MEZANINO', 'CORTES', 'GERAL', 'TIPO', 'GARAGEM', 'FACHADA', 'TOON'],
    'SKP': ['MODELAGEM', 'REFERENCIA', 'TOON'],
    'IMG': ['FACHADA', 'INTERNA', 'EXTERNA', 'UNIDADE', 'LOGO', 'REFERENCIAS', 'GERAL', 'TOON'],
    'IFC': ['BIM'],
    'Outros': ['Geral', 'TOON']
};
