...
<main class="shell">
  ...
  <section id="briefing-app" hidden>
    <header class="briefing-head"><div><p class="eyebrow">BRIEFING</p><h1 id="title"></h1><p id="subtitle"></p></div><div class="save-state" id="save-state">Carregando…</div></header>
    <div class="progress-row"><div class="progress"><span id="progress-fill"></span></div><span id="progress-label"></span></div>
    <div class="layout"><nav id="sections" aria-label="Seções"></nav><section id="form" class="form-card"></section></div>
    <footer class="footer"><span id="last-change"></span><button id="submit" class="primary">Concluir briefing</button></footer>
  </section>
</main>
<script>window.BRIEFING_ACCESS_TOKEN=<?= json_encode($token, JSON_UNESCAPED_SLASHES) ?>;</script>
