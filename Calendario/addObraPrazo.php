...
if (isset($_POST['obra_id'], $_POST['prazo'], $_POST['tipo_entrega'], $_POST['assuntoEntrega'], $_POST['usuarios_ids'])) {
    $obra_id = intval($_POST['obra_id']); // Converte para inteiro
    $prazo = $_POST['prazo'];
    ...
    // Inserir o prazo na tabela obra_prazo
    $stmt = $conn->prepare("INSERT INTO obra_prazo (obra_id, prazo, tipo_entrega, assunto_entrega) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("isss", $obra_id, $prazo, $tipo_entrega, $assunto_entrega);
