...
<body class="flow-home" data-user-name="<?php echo htmlspecialchars($userName, ENT_QUOTES, 'UTF-8'); ?>" data-backgrounds="<?php echo htmlspecialchars((string) $backgroundPayload, ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <main class="home-shell">
        <header class="home-header">
            <div>
                <h1 id="homeSalutation">Olá, <?php echo htmlspecialchars($userName, ENT_QUOTES, 'UTF-8'); ?>.</h1>
                <p id="homeDate">Carregando data</p>
            </div>
            <div class="home-header__right">
                <p class="home-quote">Disciplina hoje,<br>resultados amanhã.</p><button class="home-theme-toggle" id="themeToggle" type="button" aria-label="Alternar tema"><i class="ri-sun-line"></i></button><a class="home-avatar" href="../../infos.php" aria-label="Abrir perfil"><?php if ($userPhoto !== ''): ?><img src="<?php echo htmlspecialchars($userPhoto, ENT_QUOTES, 'UTF-8'); ?>" alt=""><?php else: ?><span><?php echo htmlspecialchars($initial); ?></span><?php endif; ?></a>
            </div>
        </header>

        <div class="home-grid" id="homeContent" aria-busy="true">
            <section class="home-card home-attention" aria-labelledby="attentionTitle">
                <header class="card-heading">
                    <h2 id="attentionTitle">Precisa de atenção <span id="attentionCount">–</span></h2><a href="../../inicio.php" aria-label="Ver todas as tarefas"><i class="ri-arrow-right-s-line"></i></a>
                </header>
                <div class="attention-list home-skeleton-list" id="attentionList"></div><a class="card-footer-link" href="../../inicio.php">Ver todas <i class="ri-arrow-right-s-line"></i></a>
            </section>
            <section class="home-card home-resume" aria-labelledby="workTitle">
                <header class="card-heading">
            ...
            <section class="home-card home-shortcuts" aria-labelledby="shortcutsTitle">
                ...
                <div class="shortcut-grid"><a href="../../Projetos/"><i class="ri-folder-3-line"></i><strong>Projetos</strong><span>Ver todos</span><b><i class="ri-arrow-right-s-line"></i></b></a><a href="../../FlowReview/"><i class="ri-checkbox-circle-line"></i><strong>Aprovações</strong><span>Pendências</span><b><i class="ri-arrow-right-s-line"></i></b></a><a href="../../ALMA/"><i class="ri-box-3-line"></i><strong>ALMA</strong><span>Biblioteca</span><b><i class="ri-arrow-right-s-line"></i></b></a><a href="../../Render/"><i class="ri-image-line"></i><strong>Render</strong><span>Fila e histórico</span><b><i class="ri-arrow-right-s-line"></i></b></a></div>
            </section>
            <section class="home-card home-next" aria-labelledby="nextTitle">
                <header class="card-heading">
                    <h2 id="nextTitle">A seguir</h2><a href="../../Calendario/">Ver agenda</a>
                </header>
                <div class="next-list" id="nextList"></div>
            </section>
            <section class="home-card home-progress" aria-labelledby="progressTitle">
                <header class="card-heading">
        ...
        <div class="home-mascot-slot" aria-hidden="true"></div>
    </main>
