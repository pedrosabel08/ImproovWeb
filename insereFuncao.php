...
$status_alteracao = $_POST['status_alteracao'];
$prazo_alteracao = $_POST['prazo_alteracao'];
...
if ($caderno_funcao_id === null || $comp_funcao_id === null || $modelagem_funcao_id === null || $finalizacao_funcao_id === null || $pos_funcao_id === null || $alteracao_funcao_id === null) {
