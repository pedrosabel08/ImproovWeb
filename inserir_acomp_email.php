...
if (!isset($data['obraAcomp']) || !isset($data['colab_id']) || !isset($data['assunto']) || !isset($data['date'])) {
...
$stmt->bind_param('iiss', $data['obraAcomp'], $data['colab_id'], $data['assunto'], $data['date']);
